    ...
    [
      {
        focus: '포트폴리오 설명',
        frequency: '84%',
        summary: '학점보다 포트폴리오 구성과 작업 의도 설명을 더 많이 평가한다는 의견이 많습니다.',
        opinions: ['작업 의도 설명 질문 빈번', '포트폴리오 순서 중요', '지원 동기 질문 비중 낮음'],
        points: ['포트폴리오설명', '작업의도', '면접', '구성순서'],
      },
      {
        focus: '문제 해결 과정',
        frequency: '78%',
        summary: '작업 결과물보다 제품 사고 과정과 논리적인 설명을 중요하게 봤다는 후기가 많습니다.',
        opinions: ['제품 사고 과정 설명 비중 높음', '문제 해결 과정 질문 빈번', '포트폴리오 순서 언급 많음'],
        points: ['문제해결', '프로세스', '제품스케치', '작업논리'],
      },
      {
        focus: '공간 구성 논리',
        frequency: '72%',
        summary: '컨셉을 공간 구조로 풀어내는 방식과 발표 흐름이 중요하게 언급됩니다.',
        opinions: ['공간 사고 과정 질문 빈번', '모형보다 컨셉 설명 중요', '작업 흐름 정리 필요'],
